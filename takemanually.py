    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "D:\\CHARUSAT\\College Projects\\Attendance-Management-system-using-face-recognition\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"D://CHARUSAT//College Projects//Attendance-Management-system-using-face-recognition//Attendance(Manually)"'
                )
